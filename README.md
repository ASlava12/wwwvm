...
**514 тестов** зелёные (mem 11 + devices 62 + cpu 312 + vm 115 +
...
test ниже) занимает **~55 секунд** на той же машине: эффективные
≈145 MIPS, ≈8 миллиардов CPU-инструкций до момента когда /init
...
Должно вывести 514 пройденных тестов на текущий момент. CI
