...
cross-ring trampoline в одном /init.
...
**570 тестов** зелёные (mem 30 + devices 77 + cpu 320 + vm 126 +
...
Должно вывести 570 пройденных тестов на текущий момент. CI
