...
**381 тест** зелёный (mem 6 + devices 38 + cpu 266 + vm 63 +
...
- **BIOS-shim**: INT 0x10 (AH=0x00 set mode / 0x02 set cursor /
  0x03 get cursor / 0x06 scroll up / 0x07 scroll down / 0x09
  char+attr / 0x0E TTY / 0x0F get mode), 0x12, 0x13 (disk read),
  0x15 (E820 + AH=88), 0x16 (AH=0x00 read / 0x01 peek / 0x02
  shift flags).
...
Должно вывести 381 пройденный тест на текущий момент. CI
