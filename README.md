...
**447 тестов** зелёные (mem 11 + devices 45 + cpu 287 + vm 93 +
tutorial-anchor 2 + wasm 4 + proxy 5). Снапшот v11.
...
Должно вывести 447 пройденных тестов на текущий момент. CI
