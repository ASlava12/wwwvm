...
**415 тестов** зелёные (mem 11 + devices 45 + cpu 270 + vm 81 +
...
Должно вывести 415 пройденных тестов на текущий момент. CI
