...
**390 тестов** зелёные (mem 6 + devices 38 + cpu 266 + vm 72 +
...
Должно вывести 390 пройденных тестов на текущий момент. CI
