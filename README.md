...
**432 тестов** зелёные (mem 11 + devices 45 + cpu 274 + vm 92 +
tutorial-anchor 2 + wasm 3 + proxy 5). Снапшот v11.
...
Должно вывести 432 пройденных тестов на текущий момент. CI
