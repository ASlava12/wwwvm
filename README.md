...
**414 тестов** зелёные (mem 11 + devices 45 + cpu 269 + vm 81 +
...
Должно вывести 414 пройденных тестов на текущий момент. CI
