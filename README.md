...
**413 тестов** зелёные (mem 11 + devices 45 + cpu 268 + vm 81 +
...
| Ring 3 + полноценный TSS + privilege transitions | большой | IRET кросс-ринг уже работает (popped CS RPL > CPL → подтягивает SS:ESP из frame); остаётся вход в ring 3 (INT/SYSENTER через TSS.SS0:ESP0) + проверки прав в инструкциях |
...
Должно вывести 413 пройденных тестов на текущий момент. CI
