...
**590 тестов** зелёные (mem 30 + devices 77 + cpu 338 + vm 128 +
...
Должно вывести 590 пройденных тестов на текущий момент. CI
