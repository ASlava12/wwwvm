...
**463 тестов** зелёные (mem 11 + devices 45 + cpu 296 + vm 98 +
tutorial-anchor 2 + wasm 6 + proxy 5). Снапшот v12.
...
Должно вывести 463 пройденных тестов на текущий момент. CI
