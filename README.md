...
**458 тестов** зелёные (mem 11 + devices 45 + cpu 293 + vm 96 +
tutorial-anchor 2 + wasm 6 + proxy 5). Снапшот v11.
...
Должно вывести 458 пройденных тестов на текущий момент. CI
